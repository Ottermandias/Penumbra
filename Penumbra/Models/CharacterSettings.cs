    ...
    public class CharacterSettings
    {
        ...
        public CharacterSettings Copy()
            => new()
            {
                ...
                ModSettingsJson = new Dictionary< string, ModSettingsNames >( ModSettingsJson ),
                ModSettings     = new Dictionary< string, ModSettings >( ModSettings )
            };
        ...
        public void UpdateModSettingsJson( List< ModInfo > allMods )
        {
            foreach( var kvp in ModSettings )
            {
                ...
                {
                    ModSettingsJson[ kvp.Key ] = new ModSettingsNames();
        ...
        public static CharacterSettings ConvertFromDefault( bool invertOrder, List< ModInfo > defaultSettings )
        {
            ...
            foreach( var mod in defaultSettings.Where( m => m.Enabled ) )
            {
